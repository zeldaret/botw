...
const char* ParticleConfig::getLightMapName(unsigned int index){
    switch(index){
        case 0:
...
void ParticleConfig::initialize(sead::Heap* a1, sead::Heap* a2){
    return ORUtil::setNodeMetaIcon(this, ORUtil::Icon::_B, a2);
}

void ParticleConfig::applyResource(u8* data){
