...
#else
[[maybe_unused]] static void dummyInstantiate() {
    BaseProcMap* map = nullptr;
    ProcForEachContext context;
    map->forEach(sead::Delegate1<ProcForEachContext, util::StrTreeMapNode*>(
        &context, &ProcForEachContext::forEach));
}

__asm__(
".text\n"
".global _ZN4ksys3act11BaseProcMgr11forEachProcERN4sead10IDelegate1IPNS0_8BaseProcEEENS2_12TypedBitFlagINS1_10ProcFilterEiEE\n"
".type _ZN4ksys3act11BaseProcMgr11forEachProcERN4sead10IDelegate1IPNS0_8BaseProcEEENS2_12TypedBitFlagINS1_10ProcFilterEiEE, %function\n"
...
"    mov     x20, x2\n"
"    mov     x21, x1\n"
"    bl      _ZN4sead15CriticalSection4lockEv\n"
"    add     x8, sp, #0x8\n"
"    stur    x8, [x29, #-0x28]\n"
"    sub     x8, x29, #0x28\n"
"    str     w20, [sp, #0x8]\n"
"    str     x21, [sp, #0x10]\n"
"    str     x8, [sp, #0x20]\n"
"    adrp    x8, :got:_ZN4ksys3act18ProcForEachContext7forEachEPNS_4util14StrTreeMapNodeE\n"
"    ldr     x8, [x8, :got_lo12:_ZN4ksys3act18ProcForEachContext7forEachEPNS_4util14StrTreeMapNodeE]\n"
"    stp     x8, xzr, [sp, #0x28]\n"
"    adrp    x8, :got:_ZTVN4sead9Delegate1IN4ksys3act18ProcForEachContextEPNS1_4util14StrTreeMapNodeEEE\n"
"    ldr     x8, [x8, :got_lo12:_ZTVN4sead9Delegate1IN4ksys3act18ProcForEachContextEPNS1_4util14StrTreeMapNodeEEE]\n"
"    add     x8, x8, #0x10\n"
"    str     x8, [sp, #0x18]\n"
"    ldr     x0, [x22, #0x98]\n"
"    cbz     x0, 1f\n"
"    add     x1, sp, #0x18\n"
"    bl      _ZN4sead11TreeMapImplIN4ksys4util13StrTreeMapKeyEE7forEachIZNKS_16IntrusiveTreeMapIS3_NS1_3act15BaseProcMapNodeEE7forEachINS_9Delegate1INS7_18ProcForEachContextEPNS2_14StrTreeMapNodeEEEEEvRKT_EUlPSG_E_EEvPNS_11TreeMapNodeIS3_EESI_\n"
"1:\n"
"    mov     x0, x19\n"
"    bl      _ZN4sead15CriticalSection6unlockEv\n"
"    ldp     x29, x30, [sp, #0x60]\n"
"    ldp     x20, x19, [sp, #0x50]\n"
"    ldp     x22, x21, [sp, #0x40]\n"
"    add     sp, sp, #0x70\n"
"    ret\n"
".size _ZN4ksys3act11BaseProcMgr11forEachProcERN4sead10IDelegate1IPNS0_8BaseProcEEENS2_12TypedBitFlagINS1_10ProcFilterEiEE, . - _ZN4ksys3act11BaseProcMgr11forEachProcERN4sead10IDelegate1IPNS0_8BaseProcEEENS2_12TypedBitFlagINS1_10ProcFilterEiEE\n"
);
#endif
