...
public:
    ...
    void setMtxAndScale(sead::Matrix34f* mtx, bool a2, bool a3, f32 scale);
    void sub_7100FBB4B4();
    ...
    void sub_7100FBD284(sead::Matrix34f* mtx);
    void sub_7100FBC890(sead::Matrix34f* mtx, bool a2, bool a3);
