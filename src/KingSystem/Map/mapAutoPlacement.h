...
class PlacementThing {
public:
    PlacementThing(bool set) : mDelegate{this, &PlacementThing::sub_7100650C28}, _8944(set) {}

    SEAD_ENUM(State, kInvalid, kFree, kNotInvoked, kInvoked, kDone, kWaiting);
...
public:
    ...
    bool sub_710064CBFC(sead::Heap* heap, u8 flag, u32 idx, u32 num_obj);
