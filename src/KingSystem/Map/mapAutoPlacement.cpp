...
static sead::Buffer<eco::AreaItemType> sPlacementTypesBuffer((eco::AreaItemType[]){
    eco::AreaItemType::Enemy,
    eco::AreaItemType::Animal,
    eco::AreaItemType::Insect,
    eco::AreaItemType::Fish,
    eco::AreaItemType::Bird,
    eco::AreaItemType::AutoPlacementMaterial,
});
